...
-- Canonical Control Hípico profile prerequisite.
-- Mirrors the table contract from supabase/sql/hipico_v13_workspace_sync_security.sql
-- so Prisma deltas can replay on disposable PostgreSQL without executing product bootstrap SQL twice.
