...
export const HealthVerticalService = {
  ...
  dentalResources() { return BackendApi.get('/verticals/health/dental-schedule/resources'); },
  createDentalResource(payload) { return BackendApi.post('/api/v1/verticals/health/dental-schedule/resources', payload); },
  dentalAppointments(params = {}) { return BackendApi.get(`/verticals/health/dental-schedule/appointments${query(params)}`); },
  createDentalAppointment(payload) { return BackendApi.post('/api/v1/verticals/health/dental-schedule/appointments', payload); },
  confirmDentalAppointment(id, payload) { return BackendApi.post(`/api/v1/verticals/health/dental-schedule/appointments/${encodeURIComponent(id)}/confirmation`, payload); },
  dentalWaitlist(params = {}) { return BackendApi.get(`/verticals/health/dental-schedule/waitlist${query(params)}`); },
  createDentalWaitlist(payload) { return BackendApi.post('/api/v1/verticals/health/dental-schedule/waitlist', payload); },
  bookDentalWaitlist(id, payload) { return BackendApi.post(`/api/v1/verticals/health/dental-schedule/waitlist/${encodeURIComponent(id)}/book`, payload); },
  dentalRecalls(params = {}) { return BackendApi.get(`/verticals/health/dental-schedule/recalls${query(params)}`); },
  createDentalRecall(payload) { return BackendApi.post('/api/v1/verticals/health/dental-schedule/recalls', payload); },
  updateDentalRecall(id, payload) { return BackendApi.post(`/api/v1/verticals/health/dental-schedule/recalls/${encodeURIComponent(id)}/status`, payload); },
