...
export const GymVerticalService = {
  ...
  foods(params = {}) { return BackendApi.get(`/verticals/gym/foods${query(params)}`); },
  createFood(payload) { return BackendApi.post('/api/v1/verticals/gym/foods', payload); },
  updateFood(id, payload) { return BackendApi.request(`/verticals/gym/foods/${encodeURIComponent(id)}`, { method:'PATCH', body:payload }); },
