...
export const GymVerticalService = {
  ...
  adherence(memberId, filters = {}) { return BackendApi.get(`/verticals/gym/adherence${query({ memberId, ...filters })}`); },
  logMealAdherence(payload) { return BackendApi.post('/api/v1/verticals/gym/adherence/meals', payload); },
  createHabit(payload) { return BackendApi.post('/api/v1/verticals/gym/adherence/habits', payload); },
  updateHabit(id, payload) { return BackendApi.request(`/verticals/gym/adherence/habits/${encodeURIComponent(id)}`, { method:'PATCH', body:payload }); },
  checkInHabit(id, payload) { return BackendApi.post(`/api/v1/verticals/gym/adherence/habits/${encodeURIComponent(id)}/checkins`, payload); },
  createAdherenceGoal(payload) { return BackendApi.post('/api/v1/verticals/gym/adherence/goals', payload); },
  updateAdherenceGoal(id, payload) { return BackendApi.request(`/verticals/gym/adherence/goals/${encodeURIComponent(id)}`, { method:'PATCH', body:payload }); },
  createProgressPhoto(payload) { return BackendApi.post('/api/v1/verticals/gym/adherence/photos', payload); },
