...
export const CommercialService = {
  ...
  restrictionCases(id){ return BackendApi.get(`/commercial/subscriptions/${encodeURIComponent(id)}/restriction-cases`); },
  suspendSubscription(id,data){ return BackendApi.post(`/commercial/subscriptions/${encodeURIComponent(id)}/suspend`,data); },
  reactivateSubscription(id,data){ return BackendApi.post(`/commercial/subscriptions/${encodeURIComponent(id)}/reactivate`,data); },
  terminateSubscription(id,data){ return BackendApi.post(`/commercial/subscriptions/${encodeURIComponent(id)}/terminate`,data); },
  transitionSubscription(){ return Promise.reject(new Error('La transición genérica fue retirada. Usa suspensión, reactivación o terminación con expediente.')); },
