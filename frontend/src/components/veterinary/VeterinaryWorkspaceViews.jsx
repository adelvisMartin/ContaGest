...
import {
  Icon, Metric, StatusChip, EmptyState, SectionCard, compactDate, onlyDate,
  phoneDigits, displayError, reportVeterinaryError, shortCode, localDateTime
} from './VeterinaryWorkspacePrimitives.jsx';
...
export function renderVeterinaryWorkspaceTab({
  ...
  studies, hospitalizations, procedures, communications, search, openDialog,
  editPatient, archivePatient, editAppointment, removeAppointment,
