...
const pageRegistry={
 dashboard:['./pages/DashboardPage.js','DashboardPage'],cotizacion:['./pages/QuotePage.js','QuotePage'],clientes:['./pages/ClientsPage.js','ClientsPage'],ventas:['./pages/SalesPage.js','SalesPage'],inventario:['./pages/InventoryPage.js','InventoryPage'],tributos:['./pages/TaxesPage.js','TaxesPage'],normativa:['./pages/RegulatoryPage.js','RegulatoryPage'],historial:['./pages/HistoryPage.js','HistoryPage'],reportes:['./pages/ReportsPage.js','ReportsPage'],contabilidad:['./pages/LedgerPage.js','LedgerPage'],'libro-mayor':['./pages/GeneralLedgerPage.js','GeneralLedgerPage'],'balance-sumas-saldos':['./pages/TrialBalancePage.js','TrialBalancePage'],'hoja-trabajo':['./pages/WorksheetPage.js','WorksheetPage'],'estados-financieros':['./pages/FinancialStatementsPage.js','FinancialStatementsPage'],'cierre-contable':['./pages/AccountingClosePage.js','AccountingClosePage'],bancos:['./pages/BankingPage.js','BankingPage'],nomina:['./pages/PayrollPage.js','PayrollPage'],proveedores:['./pages/SuppliersPage.js','SuppliersPage'],compras:['./pages/PurchasesPage.js','PurchasesPage'],auditoria:['./pages/AuditPage.js','AuditPage'],configuracion:['./pages/SettingsPage.js','SettingsPage'],ayuda:['./pages/HelpPage.js','HelpPage'],tasks:['./pages/TasksPage.js','TasksPage'],profile:['./pages/ProfilePage.js','ProfilePage'],mobile:['./pages/MobilePreviewPage.js','MobilePreviewPage'],'libro-ventas':['./pages/SalesBookPage.js','SalesBookPage'],marca:['./pages/BrandGuidelinesPage.js','BrandGuidelinesPage'],admin:['./pages/AdminPanelPage.js','AdminPanelPage'],backend:['./pages/BackendPage.js','BackendPage'],vistas:['./pages/ModuleCatalogPage.js','ModuleCatalogPage'],login:['./pages/LoginPage.js','LoginPage'],'plan-cuentas':['./pages/ChartAccountsPage.js','ChartAccountsPage'],rrhh:['./pages/HrDashboardPage.js','HrDashboardPage'],analytics:['./pages/AnalyticsPage.js','AnalyticsPage'],qr:['./pages/QrBarcodePage.js','QrBarcodePage'],'inventario-scan':['./pages/InventoryScannerPage.js','InventoryScannerPage'],pedidos:['./pages/FoodOrdersPage.js','FoodOrdersPage'],'pos-sede':['./pages/FastFoodPosPage.js','FastFoodPosPage'],'tracking-pedidos':['./pages/OrderTrackingPage.js','OrderTrackingPage'],'delivery-mapa':['./pages/DeliveryMapPage.js','DeliveryMapPage'],'asistente-ia':['./pages/AiAssistantPage.js','AiAssistantPage'],soporte:['./pages/SupportCtaPage.js','SupportCtaPage'],'demo-control':['./pages/DemoControlPage.js','DemoControlPage'],'modulos-madurez':['./pages/ModuleMaturityPage.js','ModuleMaturityPage'],'reglas-negocio':['./pages/BusinessRulesPage.js','BusinessRulesPage'],licencias:['./pages/LicensesPage.js','LicensesPage'],'importacion-data':['./pages/DataImportPage.js','DataImportPage'],kardex:['./pages/KardexPage.js','KardexPage'],'normativa-contable':['./pages/AccountingStandardsPage.js','AccountingStandardsPage'],pretesting:['./pages/PretestingDashboardPage.js','PretestingDashboardPage'],salud:['./pages/HealthcarePage.js','HealthcarePage'],veterinaria:['./pages/VeterinaryClinicPageV1123.jsx','VeterinaryClinicPage'],psicologia:['./pages/PsychologyPracticePage.js','PsychologyPracticePage'],odontologia:['./pages/DentistryPracticePage.js','DentistryPracticePage'],gimnasio:['./pages/GymManagementPage.js','GymManagementPage'],rutinas:['./pages/GymManagementPage.js','GymManagementPage'],nutricion:['./pages/GymManagementPage.js','GymManagementPage'],mensajes:['./pages/CommunicationTemplatesPage.js','CommunicationTemplatesPage']
};
...
window.addEventListener('cg:navigate',(event)=>{const route=event.detail?.route;if(route&&!canNavigate(route)){event.preventDefault();event.stopImmediatePropagation();deny();}},true);
...
async function render({force=false}={}){
  ...
  try{
    ...
    if(AuthService.isAuthenticated()&&requested!=='login'&&!AccessControlService.canAccessRoute(state,requested)){deny();UrlStateService.navigate('dashboard',{}, {replace:true});return;}
