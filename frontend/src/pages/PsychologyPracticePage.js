  ...
  render(state){
    ...
    return `<section class="cg-page-stack cg-psychology-workspace">
      ...
      <section class="cg-psych-lower-grid">
        ${Section({title:'Próximos recordatorios',subtitle:`Ventana de ${Number(state.settings?.appointmentReminderHours||24)} horas.`,children:reminderCards||EmptyState({title:'Sin recordatorios próximos',description:'Las citas cercanas aparecerán aquí.',iconName:'fa-bell-slash'})})}
