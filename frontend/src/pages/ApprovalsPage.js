...
export const ApprovalsPage={
  ...
  mount(_state,{Toast}){
    const load=async()=>{
      ...
      }catch(error){document.getElementById('approvalInbox').innerHTML=`<div class="cg-inline-error">${safe(error.message)}</div>`;document.getElementById('approvalMine').innerHTML='';document.getElementById('approvalReport').innerHTML='';Toast.show(`No se pudo cargar Aprobaciones: ${error.message}`,'error');}
    };
    void load();
  }
};
