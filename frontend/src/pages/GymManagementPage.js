...
function overview(data) {
  ...
  return `<div class="cg-gym-v1124-grid">
    ...
    <section class="cg-gym-v1124-card cg-gym-wide"><header><div><h3>Próximas clases</h3><p>Agenda disponible para operación diaria.</p></div><button type="button" class="cgx-btn cgx-btn-secondary" data-gym-tab="classes">Programar clase</button></header>${classList(data.classes || [])}</section>
  </div>`;
}
