...
export function createDefaultState() {
  return {
    version: 'v11.17.0-phase2-erpui-i18n',
    route: 'dashboard',
    settings: {
      theme: 'light',
      businessMode: 'admin',
      ...
      companyTradeName: 'ContaGest Comercial',
      ...
      companySlogan: 'Gestión empresarial, contable y operativa',
      companyLogoDataUrl: '',
    ...
    quote: {
      date: today(), numeroFactura: `FAC-${new Date().getFullYear()}-001`, orden: `ORD-${new Date().getFullYear()}-001`, clientId: '', currency: 'USD', manualAmount: 0, observation: '', items: [],
      taxes: { iva: { active: true, rate: 16 }, igtf: { active: false, rate: 3 }, islr: { active: false, rate: 2 }, custom: { active: false, rate: 0, label: 'Otro tributo' }, retIva: { active: false, rate: 75 }, retIslr: { active: false, rate: 2 } }
    },
    calculation: {},
    clients: [
    ...
    auditLog: [], failureLog: FailureLogService.defaultState(), moduleRuntime: {},
    ...
    posCart: [], foodOrders: [], demoAccess: [], aiAssistant: { messages: [] }, support: { whatsapp: '+584120000000', email: 'soporte@contagest.ve', sla: 'L-V 8:00am a 6:00pm' }, delivery: { origin: 'Sucursal Central, Caracas, Venezuela', provider: 'google_maps', fallbackProvider: 'mapbox' },
