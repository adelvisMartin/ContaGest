...
const ALL_OPERATIONAL_MODES = ['contador','comercio','restaurante','servicios','salud','veterinaria','psicologia','gimnasio','admin'];
const CLIENT_MODES = ['comercio','restaurante','servicios','salud','veterinaria','psicologia','gimnasio','admin'];
...
export const MODULE_CATALOG = [
  ...
  { route:'ventas', name:'Ventas', area:'Ventas', tier:'core', modes:['comercio','restaurante','servicios','salud','veterinaria','psicologia','gimnasio','admin'] },
  { route:'cotizacion', name:'Cotizador', area:'Ventas', tier:'core', modes:['comercio','servicios','salud','veterinaria','psicologia','gimnasio','admin'] },
  { route:'clientes', name:'Clientes', area:'Ventas', tier:'core', modes:ALL_OPERATIONAL_MODES },
  { route:'historial', name:'Histórico', area:'Ventas', tier:'advanced', modes:['comercio','servicios','salud','veterinaria','psicologia','gimnasio','admin'] },
  ...
  { route:'bancos', name:'Bancos', area:'Contabilidad', tier:'advanced', modes:['contador','comercio','salud','veterinaria','psicologia','gimnasio','admin'] },
  ...
  { route:'mensajes', name:'Mensajes WhatsApp', area:'Comunicación', tier:'core', modes:['salud','veterinaria','psicologia','gimnasio','comercio','restaurante','servicios','admin'] },
  ...
  { route:'auditoria', name:'Auditoría', area:'Analítica', tier:'advanced', modes:['contador','salud','veterinaria','psicologia','gimnasio','admin'] },
