(() => {
  ...
  function mountInstallBanner() {
    ...
    host.innerHTML = `
      <style>
        #cg-install-app{position:fixed;left:12px;right:12px;bottom:max(12px,env(safe-area-inset-bottom));z-index:2147483000;max-width:520px;margin-inline:auto;background:linear-gradient(145deg,#08152f,#0f2c63);color:#fff;border:1px solid rgba(147,197,253,.28);border-radius:22px;padding:14px;box-shadow:0 24px 70px rgba(2,6,23,.48);font-family:Inter,system-ui,sans-serif;backdrop-filter:blur(18px)}
        #cg-install-app .cg-pwa-row{display:flex;gap:12px;align-items:center}.cg-pwa-icon{width:50px;height:50px;border-radius:14px;object-fit:cover;background:#fff;box-shadow:0 8px 24px rgba(0,0,0,.2)}.cg-pwa-copy{min-width:0;flex:1}.cg-pwa-title{font-size:15px;font-weight:900;margin:0 0 4px}.cg-pwa-text{font-size:12px;line-height:1.45;color:#dbeafe;margin:0}.cg-pwa-actions{display:flex;gap:8px;margin-top:12px}.cg-pwa-btn{flex:1;min-height:44px;border:0;border-radius:13px;padding:11px 12px;font-weight:900;font-size:13px;cursor:pointer}.cg-pwa-btn:focus-visible{outline:3px solid #93c5fd;outline-offset:2px}.cg-pwa-primary{background:linear-gradient(135deg,#3b82f6,#4f46e5);color:#fff;box-shadow:0 10px 24px rgba(37,99,235,.28)}.cg-pwa-secondary{background:rgba(15,23,42,.66);color:#e2e8f0;border:1px solid #334155}.cg-pwa-help{margin-top:10px;padding:10px 12px;border-radius:12px;background:rgba(15,23,42,.62);border:1px solid rgba(148,163,184,.24);color:#dbeafe;font-size:12px;line-height:1.5}
      </style>
