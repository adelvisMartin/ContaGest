...
const SHELL_CACHE = `${CACHE_VERSION}-shell-r26-command-center-v290`;
const APP_SHELL = [
  ...
  './logo-control-hipico.png', './assets/css/app.css', './assets/css/_foundation.css',
  ...
  './assets/js/backup-secure-ui.js', './assets/js/backup-v2.js', './assets/js/backup.js', './assets/js/command-center.js', './assets/js/compat.js', './assets/js/dialog-accessibility.js',
  ...
  './assets/js/theme-bootstrap.js', './assets/js/ui.js', './assets/js/user-access.js', './assets/js/version-guard.js', './assets/js/whatsapp.js', './assets/js/workspace-input-safety.js', './assets/js/workspace.js',
