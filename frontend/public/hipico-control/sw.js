...
const SHELL_CACHE = `${CACHE_VERSION}-shell-r16-command-center`;
const APP_SHELL = [
  ...
  './assets/js/resilience.js', './assets/js/seed.js', './assets/js/store-v2.js', './assets/js/store.js', './assets/js/theme-bootstrap.js',
