...
const SHELL_CACHE = `${CACHE_VERSION}-shell-r16-version-guard`;
const APP_SHELL = [
  ...
  './assets/js/config.js', './assets/js/dialog-accessibility.js', './assets/js/engine.js', './assets/js/financial-config-guard.js', './assets/js/help-center.js',
  ...
  './assets/js/supabase.js', './assets/js/sync.js', './assets/js/ui.js', './assets/js/user-access.js', './assets/js/version-guard.js',
