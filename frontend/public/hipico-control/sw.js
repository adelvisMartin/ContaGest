...
const SHELL_CACHE = `${CACHE_VERSION}-shell-r7-production-hardening`;
const APP_SHELL = [
  ...
  './assets/js/operational-ledger.js', './assets/js/operational-copy-center.js', './assets/js/race-context-guard.js', './assets/js/notice-bridge.js',
