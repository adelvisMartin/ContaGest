...
const SHELL_CACHE = `${CACHE_VERSION}-shell-r3`;
const APP_SHELL = [
  ...
  './logo-control-hipico.png', './assets/css/styles.css', './assets/css/ui-system.css',
  ...
  './assets/js/password-recovery.js', './assets/js/user-access.js', './assets/js/resilience.js', './assets/js/agent-router-pro.js',
