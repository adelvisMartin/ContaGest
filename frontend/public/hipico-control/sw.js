...
const SHELL_CACHE = `${CACHE_VERSION}-shell-r8-complete-offline`;
const APP_SHELL = [
  ...
  './assets/js/whatsapp/normalization.js', './assets/js/whatsapp/parser.js', './assets/js/whatsapp/ui-transcript.js'
];
