...
const SHELL_CACHE = `${CACHE_VERSION}-shell-r17-production`;
const APP_SHELL = [
  ...
  './assets/js/command-center.js', './assets/js/command-center-shell.js', './assets/js/config.js', './assets/js/dialog-accessibility.js', './assets/js/engine.js', './assets/js/financial-config-guard.js', './assets/js/format.js', './assets/js/help-center.js',
  ...
  './assets/js/resilience.js', './assets/js/seed.js', './assets/js/store-v2.js', './assets/js/store.js', './assets/js/theme-bootstrap.js', './assets/js/version-guard.js',
