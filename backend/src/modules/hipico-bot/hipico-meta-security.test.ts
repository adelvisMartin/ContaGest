...
import { MIN_META_SECRET_LENGTH, metaSignatureValid, metaVerifyTokenValid, metaWebhookSecretsConfigured } from './hipico-meta-security.js';

const strong='x'.repeat(MIN_META_SECRET_LENGTH);
const env={WHATSAPP_VERIFY_TOKEN:strong,WHATSAPP_APP_SECRET:strong};
