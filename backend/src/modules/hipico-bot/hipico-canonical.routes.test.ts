...
test('canonical owner is server-side only and malformed owner config fails closed',()=>{
  assert.equal(configuredCanonicalOwnerId({HIPICO_OWNER_ID:'00000000-0000-0000-0000-000000000001'} as NodeJS.ProcessEnv),'00000000-0000-0000-0000-000000000001');
...
test('canonical schemas require group scope and reject unexpected fields',()=>{
