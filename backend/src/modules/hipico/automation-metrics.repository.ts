import type { AutomationMetrics } from './agent-policy.js';
import { type AutomationDbClient, type AutomationScope, validatedAutomationScope } from './automation-scope.js';
