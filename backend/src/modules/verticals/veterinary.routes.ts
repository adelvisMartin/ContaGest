...
const veterinaryBoardingSettingsSchema=z.object({
  enabled:z.boolean()
}).strict();
const veterinaryBoardingResourceSchema=z.object({
...
const veterinaryBoardingResourceStatusSchema=z.object({
  status:z.enum(['active','maintenance','inactive'])
}).strict();
const veterinaryBoardingAvailabilityQuerySchema=z.object({
...
const veterinaryBoardingStayQuerySchema=z.object({
  patientId:z.string().min(10).optional(),
  status:z.enum(['reserved','checked_in','completed','cancelled']).optional()
}).strict();
const veterinaryBoardingStaySchema=z.object({
  patientId:z.string().min(10),
...
const veterinaryBoardingStayTransitionSchema=z.object({
