...
import hipicoAutomationRoutes from './modules/hipico-bot/hipico-automation.routes.js';
...
export function createApp(options: { readinessCheck?: ReadinessCheck } = {}) {
  ...
  app.use('/api/v1/hipico',authRateLimit,mutationRateLimit,hipicoAutomationRoutes);
