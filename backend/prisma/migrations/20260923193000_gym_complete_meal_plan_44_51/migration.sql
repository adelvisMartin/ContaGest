...
COMMENT ON TABLE public."GymRecipe" IS '44/51 reusable meal recipe composed from canonical GymIngredient rows.';
COMMENT ON TABLE public."GymMealAlternative" IS '44/51 explicit alternative recipes; no automated restriction/preference matching until 45/51.';
