...
test('v290 schema chain applies v25 then v26 and proves their database boundaries',async()=>{
  ...
  assert.ok(p24>=0&&p25>p24&&p26>p25,'v25/v26 migration order must follow v24');
