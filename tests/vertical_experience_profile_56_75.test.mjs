...
test('56/75 every business mode derives a valid landing and quick navigation from the canonical manifest',()=>{
...
test('56/75 clinical and fitness profiles land in their own vertical instead of the generic dashboard',()=>{
  const expected={
    salud:'salud',
...
test('56/75 unknown modes fail to the administrative experience without widening authorization',()=>{
...
test('56/75 auth sessions expose the canonical experience profile and frontend persists it',()=>{
...
test('56/75 post-login home brand denied-route fallback and shell use the experience profile',()=>{
