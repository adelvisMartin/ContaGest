...
test('v290 production gate is exact-SHA, current v12-v24, real-PostgreSQL, OCR capable and multi-browser without bypasses', async () => {
  ...
  assert.match(guard, /currentPostgresChain: 'v12-v24'/);
