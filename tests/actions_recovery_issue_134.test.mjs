...
test('58/75 requires job-level runner steps and logs before workflow evidence is valid', () => {
  for (const token of [
    'collectJobEvidence',
    'runnerAssigned',
    'completedStepCount',
...
test('58/75 runner probe is exact PR-SHA observable for recovery changes', () => {
  for (const path of [
