...
async function seed(page, { lang='es', mode='admin', route='dashboard' } = {}) {
  await page.addInitScript(({ lang, mode, route }) => {
    ...
    const state={ route, settings:{ theme:'light', lang, businessMode:mode, sidebarCollapsed:false, reportCurrency:'dual' }, rbac:null };
