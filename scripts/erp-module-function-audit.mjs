...
lines.push('## Interpretación','','El auditor v16.3 sólo considera destructiva una invocación/acción real (servicio, DELETE o data-action), no palabras de estado o documentación. Las vistas render-only pueden delegar navegación/filtros en enhancers globales sin mount local. La evidencia browser sigue siendo obligatoria para demostrar comportamiento en runtime.');
